...
const files={};
for(const name of ['public/index.html','public/stable-core.js','public/app.js','public/ui-v2.js','public/map-enhancements.js','public/journey.js','public/district.js']){
